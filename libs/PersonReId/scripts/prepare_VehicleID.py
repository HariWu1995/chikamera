...
train_save_path = download_path + '/preprocessed/train_test'
...
# train
train_list = []
train_only_save_path = download_path + '/preprocessed/train'
...
for num in [800, 1600, 2400]:
    val_list = []
    query_save_path = download_path + '/preprocessed/query%d' % num
    gallery_save_path = download_path + '/preprocessed/gallery%d' % num
