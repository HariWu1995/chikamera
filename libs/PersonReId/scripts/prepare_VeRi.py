...
#---------------------------------------
# train
os.mkdir(download_path + '/preprocessed')
train_load_path = train_path
...
#---------------------------------------
# query
train_load_path = query_path
train_save_path = download_path + '/preprocessed/query'
if not os.path.isdir(train_save_path):
    os.mkdir(train_save_path)
...
#---------------------------------------
# gallery
train_load_path = gallery_path
train_save_path = download_path + '/preprocessed/gallery'
if not os.path.isdir(train_save_path):
    os.mkdir(train_save_path)
...
# train_veri_path =  './data/preprocessed/train+veri'
# original_train_save_path = './data/preprocessed/train'
