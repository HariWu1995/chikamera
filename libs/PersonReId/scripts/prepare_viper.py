...
# train_all - Camera A
ID_list = []
train_load_path = download_path + '/cam_a'
train_save_path = download_path + '/preprocessed/all'
...
# train_all - Camera B
train_load_path = download_path + '/cam_b'
train_save_path = download_path + '/preprocessed/all'
if not os.path.isdir(train_save_path):
    os.mkdir(train_save_path)
...
for ii in range(1):
    ...
    index = index[0:316]
    test_save_path = download_path + '/preprocessed/' #'/test%d'%ii
