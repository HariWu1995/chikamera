...
+ Quick Question. The dimension of the outputs is batch_size*751. Why?
```
...
```bash
python test.py --gpu_ids 0 --name ft_ResNet50 --test_dir your_data_path  --batch_size 32 --which_epoch 60
```
`--gpu_ids` which gpu to run.
