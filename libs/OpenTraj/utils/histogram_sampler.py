...
def histogram_sampler(
    ...
    """
    This function takes 
        {D}: multiple group of samples (1d)
        max_n_samples: an integer value
    to calculate the histogram of each group,
    then, divide the histogram values by a fixed ratio 
        subject to sum of each histogram < N 
    """
    # concat all_samples
