...
DATA_FIELDS = ["Year", "Month", "Day", "Hour", "min", "sec", "msec", "place", "x_mm", "y_mm", "agent_id"]
...
def load_cff(path, **kwargs):
    ...
    # copy columns
    columns = ["scene_id", "timestamp", "frame_id", "agent_id", "pos_x", "pos_y"]
...
if __name__ == '__main__':
    ...
    dataset = load_cff(f"{dataroot}/CFF/al_position2013-02-10.csv")
