...
class MOTEvaluator:
    ...
    def __init__(
        self, args, dataloader, img_size, confthre, nms_thresh, num_classes):
        """
        Args:
            ...
            nms_thresh (float): IoU threshold of non-max supression ranging from 0 to 1.
        """
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            with torch.no_grad():
                ...
                # skip the the last iters since batch_size might be not enough for batch inference
                ...
                outputs = postprocess(outputs, self.num_classes, confthre, self.nms_thresh)
