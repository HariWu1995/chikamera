...
class TrainTransform:
    ...
    def __call__(self, image, targets, input_dim):
        ...
        if len(boxes) == 0:
            ...
            image, r_o = preprocess(image, input_dim, self.means, self.std)
        ...
        image_t, r_ = preprocess(image_t, input_dim, self.means, self.std)
        ...
        if len(boxes_t) == 0:
            image_t, r_o = preprocess(image_o, input_dim, self.means, self.std)
            boxes_o *= r_o
            boxes_t = boxes_o
            labels_t = labels_o
            ids_t = ids_o
...
class ValTransform:
    ...
    def __call__(self, img, res, input_size):
        img, _ = preprocess(img, input_size, self.means, self.std, self.swap)
