...
class KalmanFilterBbox(object):
    ...
    def initiate(self, measurement):
        ...
        """
        l, t, r, b = measurement
        measurement = self.ltrb_to_xyah(measurement)
    ...
    def update(self, measurement):
        ...
        if self.mean is None:
            ...
            self.covariance = \
            self.covariance - np.linalg.multi_dot((kalman_gain, projected_cov, kalman_gain.T))
