...
Table for the 0.95 quantile of the chi-square distribution 
    with N degrees of freedom (contains values for N=1, ..., 9). 
...
class KalmanFilter(object):
    ...
    def initiate(self, measurement):
        ...
        -------
        (ndarray, ndarray)
            Returns the mean vector (8 dimensional) 
    ...
    def multi_predict(self, mean, covariance):
        ...
        covariance : ndarray
            The Nx8x8 dimensional covariance matrics of the object states at the previous time step.
    ...
    def update(self, mean, covariance, measurement):
        ...
        measurement : ndarray
            The 4 dimensional measurement vector (x, y, a, h), 
                where (x, y) is the center position, 
    ...
    def gating_distance(self, mean, covariance, measurements, only_position=False, metric='maha'):
        ...
        If `only_position` is False, the chi-square distribution has 4 DoF, otherwise 2.
        ...
        measurements : ndarray
            An Nx4 dimensional matrix of N measurements, each in format (x, y, a, h) 
                    where (x, y) is the bounding box center position, 
                            a is the aspect ratio, 
                        and h is the height.
