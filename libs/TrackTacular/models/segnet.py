...
from ..utils.misc import pack_seqdim, unpack_seqdim, matmul2, reduce_masked_mean, DEVICE
...
class Segnet(nn.Module):
    ...
    def __init__(self, Y, Z, X,
        ...
        if encoder_type == 'res101':
            ...
            self.encoder = Encoder_res34(feat2d_dim)
    ...
    def forward(self, rgb_cams, pix_T_cams, cams_T_global, vox_util, ref_T_global, prev_bev=None):
        ...
        feat_mems_ = vox_util.unproject_image_to_mem(
            ...
            matmul2(featpix_T_cams_, cams_T_ref_),  # featpix_T_ref  B*S,4,4
                    cams_T_ref_, 
                    Y, Z, X,
                    xyz_refA=None, 
                    z_sign=self.z_sign,
