...
class PerspTransDetector(nn.Module):
    ...
    def __init__(self, dataset, arch='resnet18'):
        ...
        img2world_mat = self.get_imgcoord2worldgrid_matrices(
        ...
        self.proj_mats = [
            torch.from_numpy(map_zoom_mat @ img2world_mat[cam] @ img_zoom_mat)
        ...
        self.map_classifier = nn.Sequential(nn.Conv2d(out_channel * self.num_cam + 2, 512, 3, padding=1), nn.ReLU(),
                                            ...
                                            nn.Conv2d(512, 1, 3, padding=4, dilation=4, bias=False)).to('cuda')
        pass
