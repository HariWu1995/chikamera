...
from torchreid.constants import bn_correspondants
...
def extract_test_embeddings(model_output, test_embeddings):
    embeddings, visibility_scores, id_cls_scores, \
                pixels_cls_scores, spatial_features, parts_masks = model_output
