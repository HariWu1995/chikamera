...
class VideoProcessor:
    ...
    def __init__(
        ...
        self.bbox_annotator = sv.BoxAnnotator(color=COLORS)
        self.label_annotator = sv.LabelAnnotator(color=COLORS, text_color=sv.Color.BLACK)
        self.trace_annotator = sv.TraceAnnotator(color=COLORS, position=sv.Position.CENTER, 
    ...
    def process_frame(self, frame: np.ndarray) -> np.ndarray:
        results = self.model.infer(frame, confidence=self.conf_threshold, 
...
if __name__ == "__main__":
    ...
    ### Unit-test
    default_model_id = "vehicle-count-in-drone-video/6"
    default_out_path = "./temp/supervision/out_traffic.mp4"
    default_in_path = "./temp/supervision/traffic.mov" 
    ...
    parser = argparse.ArgumentParser(description="[Supervision] Traffic Flow Analysis")
