...
def process_video(
    ...
    # model = models.get(model_name=Models.YOLO_NAS_L, pretrained_weights="coco",
    #                     num_classes=80, checkpoint_path=model_weights_path)
    model = NAS(model_weights_path)
...
if __name__ == "__main__":
    ...
    ### Unit-test
    # default_ckpt_path = "./checkpoints/YOLO/yolo_nas_l_coco.pth"
    default_ckpt_path = "./checkpoints/YOLO/yolo_nas_l.pt"
    default_out_path = "./temp/supervision/out_speed_nas.mp4"
    ...
    parser = argparse.ArgumentParser(description="[Supervision] Speed Estimation using YOLO-NAS")
