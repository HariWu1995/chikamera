...
def main(source_path: str, zone_config_path: str) -> None:
    global current_mouse_position
    ...
    while True:
        ...
        if key == KEY_ENTER or key == KEY_NEWLINE:
            ...
            save_polygons_to_json(POLYGONS, zone_config_path)
            print(f"Polygons saved to {zone_config_path}")
            break
...
if __name__ == "__main__":
    ...
    main(
        ...
        zone_config_path=arguments.zone_config_path,
    )
