...
class TacticalViewConverter:
    ...
    def __init__(self, court_image_path):
        ...
        self.key_points = [
            # left edge
            (0, 0),
            (0, int(self.height * (0.91 / self.actual_height_in_meters))),
            (0, int(self.height * (5.18 / self.actual_height_in_meters))),
            (0, int(self.height * (10.0 / self.actual_height_in_meters))),
            (0, int(self.height * (14.1 / self.actual_height_in_meters))),
            (0, int(self.height)),
            ...
            (self.width, int(self.height * (14.1 / self.actual_height_in_meters))),
            (self.width, int(self.height * (10.0 / self.actual_height_in_meters))),
            (self.width, int(self.height * (5.18 / self.actual_height_in_meters))),
            (self.width, int(self.height * (0.91 / self.actual_height_in_meters))),
            (self.width, 0),
