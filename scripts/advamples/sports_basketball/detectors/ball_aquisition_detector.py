...
class BallAquisitionDetector:
    ...
    by analyzing bounding boxes for both the ball and the players. 
    It combines distance measurements between the ball and keypoints of each player's bbox 
    with containment ratios of the ball within a player's bounding box.
    """
    def __init__(self):
        """
    ...
    def find_minimum_distance_to_ball(self, ball_center, player_bbox):
        """
        Compute the minimum distance from any key point on a player's bbox
