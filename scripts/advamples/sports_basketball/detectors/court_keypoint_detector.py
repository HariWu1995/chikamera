...
class CourtKeypointDetector:
    ...
    def get_court_keypoints(self, frames, read_from_stub=False, stub_path=None, batch_size: int = 20):
        """
        Detect court keypoints for a batch of frames using the YOLO model. 
